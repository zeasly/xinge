...
namespace Xinge\Kernel;

use Xinge\Kernel\Contracts\MessageInterface;
use Xinge\Kernel\Exceptions\BadRequestException;
use Xinge\Kernel\Exceptions\InvalidArgumentException;
use Xinge\Kernel\Messages\Message;
use Xinge\Kernel\Messages\News;
use Xinge\Kernel\Messages\NewsItem;
use Xinge\Kernel\Messages\Raw as RawMessage;
use Xinge\Kernel\Messages\Text;
use Xinge\Kernel\Support\XML;
use Xinge\Kernel\Traits\Observable;
use Xinge\Kernel\Traits\ResponseCastable;
...
class ServerGuard
{
    ...
    /**
     * @var \Xinge\Kernel\ServiceContainer
     */
    protected $app;
     ...
     * @codeCoverageIgnore
     *
     * @param \Xinge\Kernel\ServiceContainer $app
     */
     ...
     * @throws \Xinge\Kernel\Exceptions\InvalidConfigException
     */
     ...
     * @return $this
     *
     * @throws \Xinge\Kernel\Exceptions\BadRequestException
     */
     ...
     * Get request message.
     *
     * @return array|\Xinge\Kernel\Support\Collection|object|string
     *
     * @throws BadRequestException
     * @throws \Xinge\Kernel\Exceptions\InvalidArgumentException
     * @throws \Xinge\Kernel\Exceptions\InvalidConfigException
     ...
     * @param string                                                   $to
     * @param string                                                   $from
     * @param \Xinge\Kernel\Contracts\MessageInterface|string|int $message
     *
     * @return string
     *
     * @throws \Xinge\Kernel\Exceptions\InvalidArgumentException
     ...
     * @param string                                        $to
     * @param string                                        $from
     * @param \Xinge\Kernel\Contracts\MessageInterface $message
     *
     * @return string
     */
