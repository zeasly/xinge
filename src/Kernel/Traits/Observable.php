...
use Xinge\Kernel\Clauses\Clause;
use Xinge\Kernel\Contracts\EventHandlerInterface;
use Xinge\Kernel\Decorators\FinallyResult;
use Xinge\Kernel\Decorators\TerminateResult;
use Xinge\Kernel\Exceptions\InvalidArgumentException;
use Xinge\Kernel\ServiceContainer;
...
trait Observable
{
     ...
     *
     * @return \Xinge\Kernel\Clauses\Clause
     *
